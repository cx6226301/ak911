function bank_us(name) {
    ...
    if (name == 'tenpay') {
        bank.innerHTML = 'tenpay No.';
    } else if(name == 'alipay') {
        bank.innerHTML = 'alipay No.';
    }else {
        bank.innerHTML = 'The bank account';
    }
}
...
function yhPass(Pass)
{
	...
	if(E_Name)
	{
		...
		if(DvFul){DvFul.innerHTML = "<div class='msg_error'>The content of the input must be greater than 1 characters!</div>";}
		return false;
	}
	return false;
}
	...
	if(E_Name && re_Name)
	{
		...
		//{
			if(E_Name.value == re_Name.value){
				...
				if(DvFul){DvFul.innerHTML = "<div class='msg_error'>Input and validation!</div>";}
				return false;
			}
		//}
...
{ 
	...
	if (Over_Name)
	{
		...
		if (DvName){DvName.innerHTML= "<div class='msg_error'>Content cannot be empty!</div>";}
		return false;
	}
	return false;
}
...
function Null_Int(Null_N)
{
	...
	if (Null_Name)
	{
		...
		if (!str == "")//判断是否为空
		{
			...
			if(IntDvName){IntDvName.innerHTML="<div class='msg_error'>I'm sorry, please fill in the Numbers!</div>";}
			return false;
		}
		if (IntDvName){IntDvName.innerHTML= "<div class='msg_error'>Content cannot be empty!</div>";}
		return false;
	}
	return false;
}
...
function Email(sMsgId)
{
	...
	if(oEmail){
		...
		if(oEmail.value){
			...
			if(oMsg){oMsg.innerHTML = "<div class='msg_error'>E-mail format is not correct!</div>";}
			return false;
		}
	}
	return false;
...
function ChkCode(str){
	...
	if(checkIdcard(Code) == "Id card number digits is wrong"){
		Card.innerHTML = "<div class='msg_error'> Id card number digits is wrong</div>";
		return false;
	}
	if(checkIdcard(Code) == "Id card number, date of birth is beyond the scope or contains illegal characters"){
		Card.innerHTML = "<div class='msg_error'> Id card number, date of birth is beyond the scope or contains illegal characters</div>";
		return false;
	}
	if(checkIdcard(Code) == "Id card number validation errors"){
		Card.innerHTML = "<div class='msg_error'> Id card number validation errors</div>";
		return false;  
	}
	if(checkIdcard(Code) == "Id illicit"){
		Card.innerHTML = "<div class='msg_error'> Id illicit</div>";
		return false;  
	}
