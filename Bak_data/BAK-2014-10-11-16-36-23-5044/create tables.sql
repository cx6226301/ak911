...
CREATE TABLE `xt_bonus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2276 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: xt_chongzhi --
...
CREATE TABLE `xt_fck` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1638 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: xt_fck_shop --
...
CREATE TABLE `xt_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=582898 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: xt_huikui --
