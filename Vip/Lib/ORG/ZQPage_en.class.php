...
class ZQPage extends Think {
    ...
    protected $config = array('rows_info'=>'All number:','pages_info'=>'The current:','prev'=>'last','next'=>'next','up'=>'Retreat','down'=>'Fast','first'=>'Home','last'=>'End','theme'=>'%rows_info% %totalRows% %pages_info% %nowPage%/%totalPage% &nbsp; %first% %prePage% %upPage% %linkPage% %downPage% %nextPage% %end%');
	...
	public function show(){
		...
		if ($this->language == 2 ){
			$this->config['rows_info']   = 'All number:';
			$this->config['pages_info']  = 'The current:';
		}
		if ($this->language == 3){
			$this->config['rows_info']   = 'Total:';
			$this->config['pages_info']  = 'Page:';
