    ...
    <div class="l_top" id="qh_con3" style="display:none;"><h1>财务管理</h1>
        ...
        <div class="l_top" id="qh_con8" ><h1>股票市场</h1>
            ...
            <ul>
                                            ...
                                            <li><a onclick="javascript:SetUrl('__APP__/Gupiao/cody/c_id/1')">电子股买入</a></li>
                                    <li><a onclick="javascript:SetUrl('__APP__/Gupiao/cody/c_id/3')">电子股卖出</a></li>
                                    <li><a onclick="javascript:SetUrl('__APP__/Gupiao/cody/c_id/4')">电子股行情</a></li>
                                    <?php if(($fck_rs['is_boss']) >= "1"): ?><li><a onclick="javascript:SetUrl('__APP__/Gupiao/cody/c_id/3')">公司卖出电子股</a></li>
                                        <li><a onclick="javascript:SetUrl('__APP__/Gupiao/cody/c_id/5')">电子股参数设置</a></li>
