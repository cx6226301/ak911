      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tab4">
          <tr>
            ...
            <td width="60%"><div id="shopid1" class="info"><div id="0" class="focus_r" style="display:none;"><div class="msg_tip">请填写报单中心。</div></div></div></td>
          </tr>
          <tr>
            ...
            <td width="60%"><div id="RID1" class="info"><div id="1" class="focus_r" style="display:none;"><div class="msg_tip">请填写推荐人。</div></div></div> </td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right"><span class="zc_hong">*</span> <?php echo ($User_namex); ?>：</td>
            <td>
          ...
          <tr>
            ...
            <td><select name="TPL" id="TPL">
                <option value="0" <?php echo ($TPL[0]); ?>> 左区 </option>
                <option value="1" <?php echo ($TPL[1]); ?>> 右区 </option>
            </select></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
              <td align="right"><span class="zc_hong">*</span> <span id="bank_id">（开户）账户</span>：</td>
          ...
          <tr>
			...
			<tr>
				...
				<strong><span class="STYLE3"><?php echo ($s9[$key]); ?>美元</span></strong>
				<?php else: ?>
				<input name="u_level" type="radio" id="radio" value="<?php echo ($key); ?>"/>
			    <strong><span class="STYLE3"><?php echo ($s9[$key]); ?>美元</span></strong><?php endif; endforeach; endif; else: echo "" ;endif; ?>
