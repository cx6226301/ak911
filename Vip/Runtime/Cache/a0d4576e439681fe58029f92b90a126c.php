...
<div class="accounttitle"><h1>股票购买</h1></div>
            ...
            <tr>
              ...
              <table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" class="tab_l3" id="noborder">
                <tr>
                  ...
                  <tr class="bor">
                    <th height="30" align="left">股票持有数量：<span style="color:#F00;"><?php echo ($live_gp); ?></span> 个</th>
                  </tr>
                  <tr class="bor">
                    <th height="30" align="left">股票求购数量：<span style="color:#F00;"><?php echo ($gping_num); ?></span> 个</th>
                  </tr>
                  <tr class="bor">
              ...
              <table width="400" border="0" cellpadding="0" cellspacing="0" class="tab3">
                  <tr>
                    <td width="30%" height="40" align="right">求购股票数量：</td>
                  ...
                  <tr>
                    ...
                    <td align="left" style="padding-left:10px;">
                     ...
                     <?php if($gp_kg == 1): ?><span style="color:#F00">股市交易已关闭</span> <?php else: ?><input type="submit" name="button2" id="button2" onclick="if(confirm('确定购买吗?')) return true;else return false;" value="确认求购" class="btn1" /><?php endif; ?>
...
function checkf(){
	...
	if(confirm("您确定要购买总额为 "+document.form1.sNun.value+" 股票币的股票吗？\n\n每颗股票单价："+document.form1.one_price.value+"\n\n当前购买力："+mai_num)){
		return true;
	}else{
		return false;
	}
