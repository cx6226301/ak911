    ...
    <div class="c_p5"><div class="tips">请认真修改自己的个人信息。</div></div>
        ...
        <td align="right"><?php echo ($Nick_namex); ?>：</td>
          ...
          <tr>
            ...
            <td><input name="wt1" type="text" id="UserTel" value="<?php echo ($vo['wt1']); ?>" class="ipt" onkeyup="javascript:Null_Full(this.name)" onfocus="notice('30','')"  onblur="notice('30','none')"/></td>
            <td><div id="UserTel1" class="info"><div id="30" class="focus_r" style="display:none;"><div class="msg_tip">请输入密保问题。</div></div></div></td>
            </tr>
            <tr>
            <td align="right">密保答案：</td>
            <td><input name="da1" type="text" id="UserTel" value="<?php echo ($vo['da1']); ?>" class="ipt" onkeyup="javascript:Null_Full(this.name)" onfocus="notice('31','')"  onblur="notice('31','none')"/></td>
            <td><div id="UserTel1" class="info"><div id="31" class="focus_r" style="display:none;"><div class="msg_tip">请输入密保答案。</div></div></div></td>
            </tr>
