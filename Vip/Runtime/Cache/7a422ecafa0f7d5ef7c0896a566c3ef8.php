...
<div class="message">
	...
	<div class="tip">
	<?php if(isset($closeWin)): ?>Page will be automatically closed after <span class="wait"><?php echo ($waitSecond); ?></span>  second， if you don't want to wait please click  <a href="<?php echo ($jumpUrl); ?>">here</a> 
	<?php else: ?>
		Page will be automatically closed after <span class="wait"><?php echo ($waitSecond); ?></span> second，if you don't want to wait please click <a href="<?php echo ($jumpUrl); ?>">here</a><?php endif; ?>
	</div>
</div>
</body>
</html>