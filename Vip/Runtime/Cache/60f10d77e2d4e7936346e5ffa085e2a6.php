...
<table width="600" align="center">
    ...
    <input type="submit" name="Submit" value="查询"  class="button_text"/><!--&nbsp;&nbsp;您的代理账户金额：<span class="hong"><?php echo ($frs['agent_cash']); ?></span>-->
    </form></td>
    </tr>
    <tr>
      <td align="center" colspan="2">
    <img src="__PUBLIC__/Images/money_lit.png" align="absmiddle"/>&nbsp;&nbsp;&nbsp;报单币：&nbsp;<span class="hong"><?php echo ($frs['agent_cash']); ?></span></td></tr>
</table>
</div>
</body>
</html>
